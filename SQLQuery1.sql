...
-- --------------------------------------------------
-- Date Created: 11/02/2018 09:53:30
...
-- Creating foreign key on [SellPerson_t_Sell_Id] in table 'Sells'
ALTER TABLE [dbo].[Sells]
...
-- Creating foreign key on [SellUser_t_Sell_user_id] in table 'Sells'
ALTER TABLE [dbo].[Sells]
...
-- Creating foreign key on [Sell_Id] in table 'Operations'
ALTER TABLE [dbo].[Operations]
...
-- Creating foreign key on [product_id] in table 'Operations'
ALTER TABLE [dbo].[Operations]
...
-- Creating foreign key on [Operation_type_Id] in table 'Operations'
ALTER TABLE [dbo].[Operations]
...
-- Creating foreign key on [Person_Id] in table 'Sells'
ALTER TABLE [dbo].[Sells]
...
-- Creating foreign key on [Operation_type_Id] in table 'Sells'
ALTER TABLE [dbo].[Sells]
...
-- Creating foreign key on [user_id] in table 'Sells'
ALTER TABLE [dbo].[Sells]
