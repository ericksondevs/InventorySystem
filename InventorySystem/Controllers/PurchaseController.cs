...
namespace InventorySystem.Controllers
{
    public class PurchaseController : Controller
    {
        ...
        List<Sell_t> sellsList;
        List<Sell_t> SellsList
        {
            get
            {
                if (this.sellsList == null)
                {
                    this.sellsList = new List<Sell_t>();
                }
                return sellsList;
        ...
        {
            SellVm.Sells = db.Sell_t.Include(s => s.Person_t).Include(s => s.Operation_type_t).Include(s => s.User_t).Where(x => x.Operation_type_Id == 1).ToList();
        ...
        public ActionResult Create(SellViewModel sellVm)
        {
        ...
        public ActionResult Edit(int? id)
        {
            ...
            ViewBag.Person_Id = new SelectList(db.Person_t.Where(x => x.person_type == 2), "Id", "name", sell_t.Person_Id);
